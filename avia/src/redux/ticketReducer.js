...
import { FILTER_TICKETS, LOAD_TICKETS, RESET_FILTER, SORT_TICKETS_BY_PRICE, SORT_TICKETS_BY_TIME } from './types'
...
export const ticketReducer = (state = initialState, action)=>{
    switch (action.type) {
        case LOAD_TICKETS: 
        return {...state, tickets: state.tickets.concat(action.payload), loaded: !state.loaded}
        case FILTER_TICKETS: 
